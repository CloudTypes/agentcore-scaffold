...
from aws_cdk import Stack, Duration, RemovalPolicy, aws_s3 as s3, aws_iam as iam, CfnOutput
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        self.vision_bucket = s3.Bucket(
            ...
            lifecycle_rules=[
                ...
                s3.LifecycleRule(id="DeleteOldUploads", enabled=True, prefix="uploads/", expiration=Duration.days(7)),
                ...
                s3.LifecycleRule(
                    ...
                    prefix="processed/",
                    transitions=[
                        s3.Transition(storage_class=s3.StorageClass.INFREQUENT_ACCESS, transition_after=Duration.days(30))
                    ],
                ),
            ],
            cors=[
        ...
        s3_policy = iam.PolicyStatement(
            ...
            resources=[self.vision_bucket.bucket_arn, f"{self.vision_bucket.bucket_arn}/*"],
        )
        ...
        # Outputs
        CfnOutput(self, "VisionBucketName", value=self.vision_bucket.bucket_name, description="S3 bucket for vision uploads")

        CfnOutput(self, "VisionBucketArn", value=self.vision_bucket.bucket_arn, description="ARN of vision uploads bucket")

        CfnOutput(self, "BackendRoleArn", value=self.backend_role.role_arn, description="ARN of backend service role")
